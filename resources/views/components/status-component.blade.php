...
<div class="min-h-[70vh] grid place-content-center bg-gradient-to-br from-gray-900 to-gray-800 p-4">
    <section class="w-full max-w-2xl mx-auto bg-gray-800 p-6 rounded-2xl shadow-2xl border border-gray-700 
                   transform transition-all hover:scale-[1.01] hover:shadow-xl 
                   relative overflow-hidden before:absolute before:inset-10 {{ !$rejected ? "before:bg-[radial-gradient(circle_at_center,_rgba(74,_222,_128,_0.1)_0,_transparent_70%)]":"before:bg-[radial-gradient(circle_at_center,_rgba(222,_74,_74,_0.1)_0,_transparent_70%)]" }}">
        ...
        <div class="relative z-10">
            ...
            @else
                <p class="text-gray-300 mb-6 leading-relaxed">
                    ...
                    Désolé mais votre demande a été rejeté. <br> Motif:<span class="text-gray-400 font-bold"> {{ $info["motif_rejected"] ?? "NA" }} </span>
                </p>   
            @endif
